...
public class DeviceStateActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        TextView mobileNetwork = (TextView) findViewById(R.id.mobile);
        TextView docked = (TextView) findViewById(R.id.docked);
        ...
        */
        ...
        charging.setText("Mobile Is Charging " + isCharging);

        Log.d(TAG, "Is Connected? " + isConnected);
        connected.setText("Mobile Is Connected to Network " + isConnected);

        Log.d(TAG, "Is Mobile? " + isMobile);
        mobileNetwork.setText("Mobile Is Connected to Mobile Network " + isMobile);
